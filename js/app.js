...
// };
//
// let intersects = document.querySelectorall('.intersect');
...
//     if (scrollPostion >= section.offsetTop - section.offsetHeight*.4 && scrollPostion <
//     section.offsetTop + 0.6*section.offsetHeight) {
...
//   document.querySelectorAll('nav .header-area .links li a').forEach( el => {
//     el.classList.remove("active")
//   });
// }
//
// let addActiveClass = function (id) {
//   let selector = `nav .header-area .links li a[href="#${id}"]`;
